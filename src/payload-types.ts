...
export interface Post {
  ...
  title: string;
  /**
   * A short summary of the post for previews and SEO
   */
  excerpt?: string | null;
  /**
  ...
  /**
   * Rank for sorting in featured sections (lower = higher priority)
   */
...
export interface Category {
  ...
  /**
   * Color code for the category (e.g., #FF5733 or tailwind class)
   */
  color?: string | null;
  /**
   * When enabled, the slug will auto-generate from the title field on save and autosave.
...
export interface User {
  ...
  socialLinks?:
    | {
        platform: 'twitter' | 'linkedin' | 'github' | 'facebook' | 'instagram' | 'youtube' | 'website';
        url: string;
        id?: string | null;
      }[]
    | null;
  /**
   * Author score for ranking in Top Authors section
   */
...
export interface FeaturedPostsBlock {
  ...
  populateBy?: ('featured' | 'selection') | null;
  selectedPosts?: (number | Post)[] | null;
  limit?: number | null;
  layout?: ('grid' | 'heroWithSide' | 'carousel') | null;
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CategoryChipsBlock".
 */
export interface CategoryChipsBlock {
  introContent?: {
    root: {
      type: string;
      children: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "MostViewedBlock".
 */
export interface MostViewedBlock {
  introContent?: {
    root: {
      type: string;
      children: {
  ...
  timeFrame?: ('all' | 'week' | 'month') | null;
  limit?: number | null;
  showRank?: boolean | null;
  layout?: ('list' | 'grid' | 'sidebar') | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'mostViewed';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface VideoBlock {
  ...
  videoSource?: ('upload' | 'youtube' | 'vimeo' | 'external') | null;
...
export interface NewsletterBlock {
  ...
  backgroundColor?: ('default' | 'primary' | 'dark' | 'gradient') | null;
  layout?: ('horizontal' | 'vertical' | 'card') | null;
  id?: string | null;
  blockName?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AuthorShowcaseBlock".
 */
export interface AuthorShowcaseBlock {
  introContent?: {
    root: {
      type: string;
      children: {
  ...
  populateBy?: ('topAuthors' | 'selection') | null;
  selectedAuthors?: (number | User)[] | null;
  limit?: number | null;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        categoryChips?: T | CategoryChipsBlockSelect<T>;
        carousel?: T | CarouselBlockSelect<T>;
        mostViewed?: T | MostViewedBlockSelect<T>;
        video?: T | VideoBlockSelect<T>;
        newsletter?: T | NewsletterBlockSelect<T>;
        authorShowcase?: T | AuthorShowcaseBlockSelect<T>;
        grid?: T | GridBlockSelect<T>;
        customCta?: T | CustomCTABlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CategoryChipsBlock_select".
 */
export interface CategoryChipsBlockSelect<T extends boolean = true> {
  introContent?: T;
  populateBy?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "MostViewedBlock_select".
 */
export interface MostViewedBlockSelect<T extends boolean = true> {
  introContent?: T;
  sortBy?: T;
  timeFrame?: T;
  limit?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AuthorShowcaseBlock_select".
 */
export interface AuthorShowcaseBlockSelect<T extends boolean = true> {
  introContent?: T;
  populateBy?: T;
  selectedAuthors?: T;
  limit?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CustomCTABlock_select".
 */
export interface CustomCTABlockSelect<T extends boolean = true> {
  heading?: T;
  subheading?: T;
  richText?: T;
  backgroundImage?: T;
...
export interface Header {
  ...
  navItems?:
    ...
    | null;
  /**
   * Social media links to display in header
   */
  socialLinks?:
    | {
...
export interface Footer {
  id: number;
  /**
   * Footer columns with title and links
   */
  footerColumns?:
    | {
        title: string;
